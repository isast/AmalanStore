	  	...
	  	<form action="update_submit.php?id=<?php echo $get_data['id']; ?>" method="post" enctype="multipart/form-data">
	  		<fielset>
	  			<table width="420" border="0" align="center">
	  				...
	  				<td width="229"><input type="text" name="productName" value="<?php echo $get_data['productName']; ?>"/></br></td></tr>
	  				
				<tr><td colspan="2"></br></br>Current Image</td></tr>
  			<tr><td colspan="2" align="center"><img src="upload/<?php echo $get_data['imageFile']; ?>" width="150" height="150" ></td></tr>
